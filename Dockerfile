...
COPY docker/binary_push.sh docker/binary_simulate.sh docker/full.sh docker/metadata_index.sh docker/metadata_simulate.sh docker/setup.sh /root/
RUN chmod u+x binary_push.sh binary_simulate.sh full.sh metadata_index.sh metadata_simulate.sh setup.sh
